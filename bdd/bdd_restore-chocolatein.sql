...
-- ----------------------------
CREATE USER admin@'%';
GRANT ALL PRIVILEGES ON *.* to admin@'%' IDENTIFIED BY 'P@ssw0rdMariaDB' WITH GRANT OPTION;
FLUSH PRIVILEGES;

-- ----------------------------------
-- Création de la BDD "chocolatein" -
-- ----------------------------------
CREATE DATABASE IF NOT EXISTS chocolatein_vuln DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE chocolatein_vuln;
