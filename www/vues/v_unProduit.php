...
<article class="row my-2">
    ...
    if (isset($recherche)) {
        $nomPdt = Helper::surligneUneExpression($recherche, $nomPdt);
        $descriptionPdt = Helper::surligneUneExpression($recherche, $descriptionPdt);
    }
    ?>
    <div class="row">
        <div class="col-lg-12">
            ...
            if (!empty($lesDetailsProduit)) {
                ...
                <ul>
                    ...
                    foreach ($lesDetailsProduit as $unDetail) {
                        if (isset($recherche)) {
                            $unDetail = Helper::surligneUneExpression($recherche, $unDetail);
                        }
                        ?>
                        <li><?= $unDetail ?></li>
                        <?php
